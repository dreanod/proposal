...
\begin{center}
{\bf\Large Forecasting the Chlorophyll level in the Red Sea using remotely-sensed data: From data-driven to model-driven approaches.}\vfill
{\Large Thesis by}\\
...
\noindent{Committee Chairperson: Ibrahim Hoteit}\\
Committee Member: Bani Mallick\\
Committee Member: ??????????\vfill
